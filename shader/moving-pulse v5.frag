...
// To-do
// - Consider blending fade-in with pulse-head colors
// - Discrete output: should it be calculated from same position of LED, or equal distance from pulse?
...
void Initialize_pulse_settings_array(inout Pulse_settings pulse[size_of_display_in_columns]){
    ...
    pulse[0] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.05), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0), 5.0,     1.0,    3.0,  0.0,  0.0,  0.0,  0.025,   0.0,     false,  false, true,  true);    // Mouse bottom
    pulse[1] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.05), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0), 3.0,     1.0,    3.0,  0.0,  0.0,  0.0,  0.025,   0.0,     false,  false, true,  true);    // Mouse scroll wheel
    pulse[2] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.1 ), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0), 3.0,     1.0,    3.0,  0.0,  0.0,  0.0,  0.025,   0.0,     false,  false, true,  true);    // Mouse logo
    pulse[3] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0 ), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0), 14.0,    1.0,    3.0,  0.0,  0.0,  0.0,  0.025,   0.0,     false,  false, true,  true);    // Case Front
    pulse[4] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0 ), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0), 10.0,    1.0,    3.0,  0.0,  0.0,  0.0,  0.025,   0.0,     false,  false, true,  true);    // Case Top
    pulse[5] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0 ), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0), 8.0,     1.0,    3.0,  0.0,  0.0,  0.0,  0.025,   0.0,     false,  false, true,  true);    // Motherboard - Z490D
    pulse[6] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0 ), vec3(0.5, 0.0, 0.0), vec3(0.0, 0.0, 0.0), 4.0,     0.0,    999.0,  0.0,  0.0,  10.0, 0.025,   0.0,     false,  false, true,  true);    // Graphics Card
    pulse[7] = Pulse_settings(vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0 ), vec3(0.0, 1.0, 0.0), vec3(0.0, 0.0, 0.0), 8.0,     1.0,    3.0,  0.0,  0.0,  0.0,  0.025,   0.0,     false,  false, true,  true);    // Motherboard - Asus Aura
